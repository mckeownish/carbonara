...
class TestCarbonara(unittest.TestCase):
    ...
    def test_files_written_simple(self):
        ...
        expected_docs =  [  'newFitData/test_simple/fitdata/fitLog1.dat',
                    ...
                    'newFitData/test_simple/fitdata/mol2_1.dat',
                    'newFitData/test_simple/fitdata/fitLog3.dat',
                    'newFitData/test_simple/fitdata/scatter1.dat',
                    'newFitData/test_simple/fitdata/mol3_1.dat',
                    'newFitData/test_simple/fitdata/mol1_1.dat',
                    'newFitData/test_simple/fitdata/scatter3.dat',
                    'newFitData/test_simple/fitdata/scatter2.dat',
                    'newFitData/test_simple/fitdata/mol2origScatter.dat',
                    'newFitData/test_simple/fitdata/mol3origScatter.dat',
                    'newFitData/test_simple/fitdata/mol1origScatter.dat']
