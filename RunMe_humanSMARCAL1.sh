...
CLEAR_DIR="$ROOT/newFitData/humanSMARCAL1/fitdata"
...
ScatterFile=$ROOT/newFitData/humanSMARCAL1/Saxs.dat
### argv[ 2] sequence file location
fileLocs=$ROOT/newFitData/humanSMARCAL1/
...
fixedsections=$ROOT/newFitData/humanSMARCAL1/varyingSectionSecondary1.dat
...
scatterOut=$ROOT/newFitData/humanSMARCAL1/fitdata
...
mixtureFile=$ROOT/newFitData/humanSMARCAL1/mixtureFile.dat
### argv[15] previous fit string in form fitname/mol6Substep_10_1.dat+fitname/mol6Substep_10_2.dat
prevFitStr=$ROOT/newFitData/humanSMARCAL1/redundant
### argv[16] log file location
logLoc=$ROOT/newFitData/humanSMARCAL1/fitdata
