...
CLEAR_DIR="$ROOT/carbonara_runs/humanSMARCAL1/fitdata"
...
ScatterFile=$ROOT/carbonara_runs/humanSMARCAL1/Saxs.dat
### argv[ 2] sequence file location
fileLocs=$ROOT/carbonara_runs/humanSMARCAL1/
...
fixedsections=$ROOT/carbonara_runs/humanSMARCAL1/varyingSectionSecondary1.dat
...
predictionFile=$ROOT/carbonara_runs/humanSMARCAL1/fitdata
### argv[13] scattering output file
scatterOut=$ROOT/carbonara_runs/humanSMARCAL1/fitdata
...
mixtureFile=$ROOT/carbonara_runs/humanSMARCAL1/mixtureFile.dat
### argv[15] previous fit string in form fitname/mol6Substep_10_1.dat+fitname/mol6Substep_10_2.dat
prevFitStr=$ROOT/carbonara_runs/humanSMARCAL1/redundant
### argv[16] log file location
logLoc=$ROOT/carbonara_runs/humanSMARCAL1/fitdata
