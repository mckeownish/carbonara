...
ROOT=$(dirname "$(readlink -f "$0")")
 ...
 ScatterFile=$ROOT/newFitData/test_multi/Saxs.dat

 ### argv[ 2] sequence file location
 fileLocs=$ROOT/newFitData/test_multi/
 ...
 fixedsections=$ROOT/newFitData/test_multi/varyingSectionSecondary1.dat
 ...
 predictionFile=$ROOT/newFitData/test_multi/fitdata

 ### argv[13] scattering output file
 scatterOut=$ROOT/newFitData/test_multi/fitdata
 ...
 mixtureFile=$ROOT/newFitData/test_multi/mixtureFile.dat
 ...
 logLoc=$ROOT/newFitData/test_multi/fitdata
